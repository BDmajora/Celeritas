...
public record ShaderProperties(
    ...
    public static ShaderProperties load(ShaderPack pack) {
        return load(pack, java.util.Collections.emptyMap());
    }
    ...
    public static ShaderProperties load(ShaderPack pack, Map<String, String> optionOverrides) {
        ...
        if (!pack.hasResource(layout.propertiesPath())) {
            ...
            Map<ProgramId, ShaderProgramDirectives> programDirectives = inheritProgramDirectiveFallbacks(
                    buildProgramDirectives(programDrawBuffers, java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), renderTargets)
            );
        ...
        ShaderTextureDirectives textureDirectives = new ShaderTextureDirectives(
                ...
                java.util.Collections.unmodifiableList(new java.util.ArrayList<>(rawTextures)),
        ...
        return new ShaderProperties(
                ...
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(viewportScales)),
                translations,
                blockIds,
                entityIds,
                itemIds,
                ...
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(programArrayEnabledExpressions)),
                indirectPointers
        );
    }
    ...
    private static AlphaTests parseAlphaTests(Properties properties, ShaderOptions options) {
        ...
        return new AlphaTests(java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(alphaTests)), java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(programAlphaTests)), java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(arrayAlphaTests)));
    }
    ...
    private static BlendModes parseBlendModes(Properties properties, ShaderOptions options) {
        ...
        return new BlendModes(
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(blendModes)),
                copyBlendAttachmentMap(attachmentModes),
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(programBlendModes)),
                copyProgramBlendAttachmentMap(programAttachmentModes),
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(arrayBlendModes)),
    ...
    private static ShaderOitSettings parseOitSettings(Properties properties) {
        ...
        return new ShaderOitSettings(
                enabled,
                java.util.Collections.unmodifiableList(new java.util.ArrayList<>(coefficientRanks)),
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(gbufferBuffers)),
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(gbufferFormats))
        );
    }
    ...
    private static Map<RenderPass, Map<Attachment, ShaderBlendMode>> copyBlendAttachmentMap(Map<RenderPass, Map<Attachment, ShaderBlendMode>> source) {
        ...
        source.forEach((pass, modes) -> {
            if (!modes.isEmpty()) {
                copy.put(pass, java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(modes)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
    ...
    private static CustomUniformSet parseCustomUniforms(Properties properties) {
        ...
        return CustomUniformSet.parse(java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(expressions)));
    }
    ...
    private static List<ShaderImageDirective> parseImages(Properties properties, ShaderOptions options) {
        ...
        return java.util.Collections.unmodifiableList(new java.util.ArrayList<>(images));
    }
    ...
    private static Map<Integer, ShaderStorageBufferDirective> parseStorageBuffers(Properties properties, ShaderOptions options) {
        ...
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(buffers));
    }
    ...
    private static Map<String, ShaderIndirectPointer> parseIndirectPointers(Properties properties) {
        ...
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(pointers));
    }
    ...
    private static Map<ProgramId, Map<Attachment, ShaderBlendMode>> copyProgramBlendAttachmentMap(Map<ProgramId, Map<Attachment, ShaderBlendMode>> source) {
        ...
        source.forEach((programId, modes) -> {
            if (!modes.isEmpty()) {
                copy.put(programId, java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(modes)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
    ...
    private static Map<ProgramArrayKey, Map<Attachment, ShaderBlendMode>> copyProgramArrayBlendAttachmentMap(
        ...
        source.forEach((arrayKey, modes) -> {
            if (!modes.isEmpty()) {
                copy.put(arrayKey, java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(modes)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
    ...
    private static Map<ProgramId, ShaderProgramDirectives> buildProgramDirectives(
        ...
        for (RenderPass pass : RenderPass.values()) {
            ...
            ShaderProgramDirectives next = new ShaderProgramDirectives(
                    programId,
                    drawBuffers.getOrDefault(programId, java.util.Collections.emptyList()),
                    viewportScales.getOrDefault(programId, ShaderViewportScale.DEFAULT),
                    alphaTests.get(programId),
                    blendModes.get(programId),
                    attachmentBlendModes.getOrDefault(programId, java.util.Collections.emptyMap()),
                    renderTargets.clearDisabledForPass(pass),
                    renderTargets.mipmapEnabled(pass),
                    explicitFlips.getOrDefault(programId, java.util.Collections.emptyMap())
            );
            directives.merge(programId, next, ShaderProperties::mergeProgramDirectives);
        }
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(directives));
    }
    ...
    private static Map<ProgramArrayKey, ShaderProgramDirectives> buildProgramArrayDirectives(
        ...
        for (ProgramArrayKey key : keys) {
            ...
            directives.put(key, new ShaderProgramDirectives(
                    ...
                    drawBuffers.getOrDefault(key, java.util.Collections.emptyList()),
                    viewportScales.getOrDefault(key, ShaderViewportScale.DEFAULT),
                    alphaTests.get(key),
                    blendModes.get(key),
                    attachmentBlendModes.getOrDefault(key, java.util.Collections.emptyMap()),
                    renderTargets.clearDisabledForPass(bindingPass),
                    renderTargets.mipmapEnabled(bindingPass),
                    explicitFlips.getOrDefault(key, java.util.Collections.emptyMap())
            ));
        }
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(directives));
    }
    ...
    private static Map<ProgramId, ShaderProgramDirectives> inheritProgramDirectiveFallbacks(Map<ProgramId, ShaderProgramDirectives> source) {
        ...
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(inherited));
    }
    ...
    private static Map<String, ShaderScreen> defaultScreens(ShaderOptions options) {
        ...
        return com.l.ausm.impl.util.J8.map("screen", new ShaderScreen("screen", entries));
    }
    ...
    private static List<ShaderCustomTextureBinding> parseCustomTextures(
        ...
        return java.util.Collections.unmodifiableList(new java.util.ArrayList<>(globalTextures));
    }
    ...
    private static TextureFiltering textureFiltering(ShaderPack pack, String resourcePath, boolean defaultBlur, boolean defaultClamp) {
        ...
        try (InputStream stream = pack.getResourceAsStream(metaPath)) {
            ...
            String meta = new String(com.l.ausm.impl.util.J8.readAllBytes(stream), StandardCharsets.UTF_8);
    ...
    private static double parseDirectiveDouble(String token, ShaderOptions options) {
        ...
        try {
            ...
            if (option == null || option.value() == null || option.value().trim().isEmpty()) {
    ...
    private static List<RenderPass> adaptTextureScopeToRenderPasses(List<ProgramId> programIds) {
        ...
        return java.util.Collections.unmodifiableList(new java.util.ArrayList<>(passes));
    }

    private static List<ProgramId> resolveTextureProgramScope(String scope) {
        ProgramId programId = resolveProgramId(scope);
        if (programId != null) {
            return com.l.ausm.impl.util.J8.list(programId);
        }
        ...
        if (stage != null) {
            ...
            return java.util.Collections.unmodifiableList(new java.util.ArrayList<>(ids));
        }

        return switch (scope) {
            case "begin", "setup", "shadowcomp" -> java.util.Collections.emptyList();
    ...
    private static Map<ProgramId, List<ShaderCustomTextureBinding>> copyProgramTextureMap(Map<ProgramId, List<ShaderCustomTextureBinding>> source) {
        ...
        source.forEach((programId, textures) -> {
            if (!textures.isEmpty()) {
                copy.put(programId, java.util.Collections.unmodifiableList(new java.util.ArrayList<>(textures)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
    ...
    private static Map<ShaderProgramArrayKey, List<ShaderCustomTextureBinding>> copyProgramArrayTextureMap(
        ...
        source.forEach((key, textures) -> {
            if (!textures.isEmpty()) {
                copy.put(key, java.util.Collections.unmodifiableList(new java.util.ArrayList<>(textures)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
    ...
    private static Map<RenderPass, List<ShaderCustomTextureBinding>> copyTextureMap(Map<RenderPass, List<ShaderCustomTextureBinding>> source) {
        ...
        source.forEach((pass, textures) -> {
            if (!textures.isEmpty()) {
                copy.put(pass, java.util.Collections.unmodifiableList(new java.util.ArrayList<>(textures)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
    ...
    private static Map<RenderPass, Map<Attachment, Boolean>> copyFlipMap(Map<RenderPass, Map<Attachment, Boolean>> source) {
        ...
        source.forEach((pass, flips) -> {
            if (!flips.isEmpty()) {
                copy.put(pass, java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(flips)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
    ...
    private static Map<ProgramId, Map<Attachment, Boolean>> copyProgramFlipMap(Map<ProgramId, Map<Attachment, Boolean>> source) {
        ...
        source.forEach((programId, flips) -> {
            if (!flips.isEmpty()) {
                copy.put(programId, java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(flips)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
    ...
    private static Map<ProgramArrayKey, Map<Attachment, Boolean>> copyProgramArrayFlipMap(
        ...
        source.forEach((arrayKey, flips) -> {
            if (!flips.isEmpty()) {
                copy.put(arrayKey, java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(flips)));
            }
        });
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
    }
