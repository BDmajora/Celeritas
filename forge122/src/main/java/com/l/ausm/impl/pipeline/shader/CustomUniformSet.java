...
public final class CustomUniformSet {
    ...
    public static CustomUniformSet empty() {
        return new CustomUniformSet(java.util.Collections.emptyMap(), java.util.Collections.emptyList(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap());
    }
    ...
    public static CustomUniformSet parse(Map<String, String> expressions) {
        ...
        return new CustomUniformSet(
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(expressions)),
                java.util.Collections.unmodifiableList(new java.util.ArrayList<>(rawUniforms)),
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(variables)),
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(compiledVariables))
        );
    }
    ...
    private static final class ExpressionEvaluator {
        ...
        static CompiledExpression compile(String expression) {
            ...
            try {
                ...
                if (body != null || parts.size() > 1) {
                    ...
                    return new VectorExpression(java.util.Collections.unmodifiableList(new java.util.ArrayList<>(nodes)));
                }
        ...
        private static String constructorName(String expression) {
            for (String prefix : com.l.ausm.impl.util.J8.list(
                    "vec2", "vec3", "vec4",
                    "ivec2", "ivec3", "ivec4",
                    "bvec2", "bvec3", "bvec4",
                    "mat2", "mat3", "mat4"
    ...
    private static final class ScalarExpressionParser {
        ...
        private List<ScalarNode> parseArguments() {
            ...
            while (true) {
                ...
                skipWhitespace();
                if (match(')')) {
                    return java.util.Collections.unmodifiableList(new java.util.ArrayList<>(arguments));
                }
                if (!match(',')) {
                    throw new ParseException();
                }
