...
public final class ShaderProgramSet {
    ...
    private ShaderProgramSet(
        ...
        this.programs = java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(programs));
        this.programArrays = java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(programArrays));
        this.computeArrays = java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(computeArrays));
        this.shadowComputes = java.util.Collections.unmodifiableList(new java.util.ArrayList<>(shadowComputes));
        this.finalComputes = java.util.Collections.unmodifiableList(new java.util.ArrayList<>(finalComputes));
    }
    ...
    public List<ShaderProgramSource> programArray(ProgramArrayId arrayId) {
        return programArrays.getOrDefault(arrayId, java.util.Collections.emptyList());
    }

    public List<ComputeProgramSource> computeArray(ProgramArrayId arrayId) {
        return computeArrays.getOrDefault(arrayId, java.util.Collections.emptyList());
    }
    ...
    private static List<ShaderProgramSource> loadProgramArray(
        ...
        return java.util.Collections.unmodifiableList(new java.util.ArrayList<>(sources));
    }
    ...
    private static String readKnownExisting(ShaderPack pack, String path) {
        ...
        try (InputStream stream = pack.getResourceAsStream(path)) {
            return stream == null ? null : new String(com.l.ausm.impl.util.J8.readAllBytes(stream), StandardCharsets.UTF_8);
        } catch (IOException e) {
