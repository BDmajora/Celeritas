...
public final class PipelineProgram {
    ...
    private static List<Attachment> defaultDrawBuffers(ProgramStage stage) {
        return switch (stage) {
            case PREPARE, GBUFFERS, DEFERRED, COMPOSITE -> com.l.ausm.impl.util.J8.list(Attachment.COLOR);
    ...
    public void setDrawBuffers(List<Attachment> drawBuffers) {
        this.drawBuffers = java.util.Collections.unmodifiableList(new java.util.ArrayList<>(drawBuffers));
    }
