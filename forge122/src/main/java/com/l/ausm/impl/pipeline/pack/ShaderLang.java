...
public final class ShaderLang {
    ...
    public static Map<String, String> load(ShaderPack pack, ShaderPackLayout layout) {
        ...
        return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(translations));
    }

    private static List<String> candidatePaths(ShaderPackLayout layout) {
        String language = currentLanguage();
        if (language.equals("en_US")) {
            return com.l.ausm.impl.util.J8.list(
    ...
    private static String currentLanguage() {
        ...
        if (mc == null || mc.gameSettings == null || mc.gameSettings.language == null || mc.gameSettings.language.trim().isEmpty()) {
            return "en_US";
        }
