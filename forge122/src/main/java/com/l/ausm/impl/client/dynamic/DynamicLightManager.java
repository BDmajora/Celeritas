...
public final class DynamicLightManager {
    ...
    private static volatile List<DynamicLightSource> activeSources = java.util.Collections.emptyList();
    private static Map<String, DynamicLightSource> previousSources = java.util.Collections.emptyMap();
    ...
    private static void update(Minecraft minecraft, boolean forceRebuild) {
        ...
        if (world != previousWorld) {
            activeSources = java.util.Collections.emptyList();
            previousSources = java.util.Collections.emptyMap();
            previousWorld = world;
        }
        ...
        activeSources = java.util.Collections.unmodifiableList(new java.util.ArrayList<>(next.values()));
