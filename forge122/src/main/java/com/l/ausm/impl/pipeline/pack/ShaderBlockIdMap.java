...
public final class ShaderBlockIdMap {
    ...
    public static BlockIdRules load(ShaderPack pack, ShaderPackLayout layout) {
        ...
        return new BlockIdRules(java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(blockIds)), java.util.Collections.unmodifiableList(new java.util.ArrayList<>(stateRules)), java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(layerOverrides)));
    }
