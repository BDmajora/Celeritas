...
public final class ShaderFeatureValidator {
    ...
    public static Result validate(ShaderPackDirectives directives) {
        ...
        return new Result(java.util.Collections.unmodifiableList(new java.util.ArrayList<>(errors)), java.util.Collections.unmodifiableList(new java.util.ArrayList<>(warnings)));
    }
