...
public final class ShaderItemIdMap {
    ...
    public static ItemIdRules load(ShaderPack pack, ShaderPackLayout layout) {
        ...
        return new ItemIdRules(java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(itemIds)), java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(metadataIds)));
    }
