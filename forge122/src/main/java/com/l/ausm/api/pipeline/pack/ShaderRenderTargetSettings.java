...
public record ShaderRenderTargetSettings(
    ...
    public static ShaderRenderTargetSettings empty() {
        return new ShaderRenderTargetSettings(java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), false);
    }
    ...
    public ShaderRenderTargetSettings withFormats(Map<Attachment, ColorBufferFormat> overrides) {
        ...
        return new ShaderRenderTargetSettings(
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(mergedFormats)),
                clearDisabledByPass,
                mipmapEnabledByPass,
                textureScales,
                clearColors,
    ...
    public ShaderRenderTargetSettings withClearColors(Map<Attachment, float[]> overrides) {
        ...
        return new ShaderRenderTargetSettings(
                ...
                mipmapEnabledByPass,
                textureScales,
                java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(mergedClearColors)),
                shadowDepthNearest,
                shadowDepthMipmap,
                shadowColorClear,
                shadowColorNearest,
    ...
    public Set<Attachment> clearDisabledForPass(RenderPass pass) {
        return clearDisabledByPass.getOrDefault(pass, java.util.Collections.emptySet());
    }

    public Set<Attachment> mipmapEnabled(RenderPass pass) {
        return mipmapEnabledByPass.getOrDefault(pass, java.util.Collections.emptySet());
    }
    ...
    public static final class Builder {
        ...
        public ShaderRenderTargetSettings build() {
            return new ShaderRenderTargetSettings(
                    java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(formats)),
                    copyPassMap(clearDisabledByPass),
                    copyPassMap(mipmapEnabledByPass),
                    java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(textureScales)),
                    copyClearColors(clearColors),
                    java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(shadowDepthNearest)),
                    java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(shadowDepthMipmap)),
                    java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(shadowColorClear)),
                    java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(shadowColorNearest)),
                    java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(shadowColorMipmap)),
                    shadowHardwareFiltering
            );
        }
        ...
        private static Map<RenderPass, Set<Attachment>> copyPassMap(Map<RenderPass, Set<Attachment>> source) {
            ...
            source.forEach((pass, attachments) -> {
                if (!attachments.isEmpty()) {
                    copy.put(pass, java.util.Collections.unmodifiableSet(new java.util.LinkedHashSet<>(attachments)));
                }
            });
            return java.util.Collections.unmodifiableMap(new java.util.LinkedHashMap<>(copy));
        }
