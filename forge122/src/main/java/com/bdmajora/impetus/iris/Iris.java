...
import com.bdmajora.impetus.iris.config.IrisConfig;
import com.bdmajora.impetus.iris.pipeline.IrisPipeline;
...
import com.bdmajora.impetus.iris.shaderpack.option.values.MutableOptionValues;
...
/**
 * Entry point and global state holder for the Iris shader layer inside Impetus.
 * <p>
...
public final class Iris {
    public static final String MODNAME = "Impetus/Iris";
