...
/**
 * One {@code texture.<stage>.<sampler>} raw-texture directive resolved the Iris way: instead of hijacking the sampler
 ...
 *
 * @see com.bdmajora.impetus.iris.shaderpack.texture.CustomTextureTransformer
 */
