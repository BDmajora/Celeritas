 ...
 * <p>
 * OFF unless {@code -Dimpetus.umbra.sunProbeFrame=<n>} names a frame to sample; pick a frame after the world is up
 * (a few hundred), then look at the sun and read the single {@code SunProbe} line.
 */
public final class SunProbe {
    private static final Logger LOGGER = LogManager.getLogger("Impetus/Umbra");
    private static final int PROBE_FRAME = Integer.getInteger("impetus.umbra.sunProbeFrame", -1);
