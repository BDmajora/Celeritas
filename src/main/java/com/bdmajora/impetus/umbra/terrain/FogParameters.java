 ...
 * {@code EntityRenderer.setupFog} ({@code setFogStart(far * 0.25)}, {@code setFogEnd(far)}). Umbra renames
 ...
 * <p>
 * <strong>Why per-field substitution rather than Umbra's struct.</strong> Umbra injects
 ...
 * <p>
 * {@code scale} is the one that cannot be a stand-alone declaration: Umbra computes {@code 1.0 / (end - start)} from
...
final class FogParameters {
    /**
     * GLSL for {@code gl_Fog.scale}. Umbra writes {@code 1.0 / (iris_FogEnd - iris_FogStart)} unguarded; the
