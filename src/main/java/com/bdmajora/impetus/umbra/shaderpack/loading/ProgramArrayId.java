 ...
 * {@code composite0}).
 * <p>
 * Umbra allows 100 entries per family; OptiFine on 1.12.2 stopped at 16, but packs written against Umbra routinely go
...
public enum ProgramArrayId {
    /** Compute-only, run once when the pack loads (Umbra {@code setup}, e.g. Photon's LPV initialization). */
    Setup("setup", 100),
    Begin("begin", 100),
