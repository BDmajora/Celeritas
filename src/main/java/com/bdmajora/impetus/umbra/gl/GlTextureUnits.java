 ...
 *   <li><b>Umbra</b> raw-binds for speed but keeps the cache authoritative through a {@code GlStateManagerAccessor}
...
public final class GlTextureUnits {
     ...
     * all of them every time it is used, so that would be sixty redundant selector moves per program bind. Umbra has
