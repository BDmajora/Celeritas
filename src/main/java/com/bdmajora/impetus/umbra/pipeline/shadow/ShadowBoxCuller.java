...
/**
 * Port of Umbra's {@code shadows.frustum.BoxCuller} (its {@code isCulledSodium} form): keeps the shadow pass to a cube
 ...
 * <p>
 * This is deliberately the <em>only</em> shadow culling implemented. Umbra also ships
 ...
 * the pack's own {@code shadowDistance} is a conservative superset of what either Umbra mode would keep.
 */
public final class ShadowBoxCuller implements Frustum {
    ...
    /** {@inheritDoc} The engine's contract is "true if visible", the inverse of Umbra's {@code isCulled}. */
    @Override
