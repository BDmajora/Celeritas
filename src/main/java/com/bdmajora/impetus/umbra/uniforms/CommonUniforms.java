...
public final class CommonUniforms {
    ...
    /**
     * Umbra feeds this from {@code level.endFlashState().getIntensity(tickDelta)} — the strength of the End's
    ...
    /**
     * Umbra reports the MAIN RENDER TARGET's size for these, not the window's
