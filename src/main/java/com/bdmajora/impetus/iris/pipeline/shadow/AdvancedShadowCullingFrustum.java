...
/**
 * A shadow frustum fitted to the player's view, from the shadow light's point of view. Port of Iris's
 ...
 * <p>
 * Derived from L. Spiro's algorithm, as Iris's version is; the plane-intersection step follows the same
