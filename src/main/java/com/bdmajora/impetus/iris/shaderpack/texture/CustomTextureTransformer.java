...
/**
 * The string-level counterpart of Iris's {@code TextureTransformer}: renames a sampler identifier to the raw custom
...
public final class CustomTextureTransformer {
    ...
    public static String transform(String programName, String source, TextureStage stage,
        ...
        for (CustomTexturePatch patch : patches) {
            ...
            declarationScan = stripComments(result);
            LOGGER.info("[Iris] Program '{}': custom texture {} declared as {} -> {}",
    ...
    /** Iris {@code TextureTransformer.isTypeValid}: the directive's target vs. the declared sampler type. */
