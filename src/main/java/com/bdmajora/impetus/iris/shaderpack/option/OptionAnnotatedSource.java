...
import com.bdmajora.impetus.iris.shaderpack.option.values.OptionValues;
import com.bdmajora.impetus.iris.shaderpack.parsing.ParsedString;
 ...
 * <p>
 * Ported from Iris. Guava collections are replaced with unmodifiable Java collections, fastutil {@code IntList} with
 * {@link List}{@code <Integer>}, and Iris's {@code LineTransform} indirection is inlined into {@link #apply}.
 */
