 ...
 * <h3>Implemented</h3>
 * <ul>
 *   <li>{@link com.bdmajora.impetus.iris.shaderpack.ShaderPackLoader} — folder/zip reading (java.nio/zip only).</li>
 *   <li>{@link com.bdmajora.impetus.iris.shaderpack.ShaderPack} / {@code ProgramSet} / {@code ProgramSource} — the
 ...
 *   <li>{@link com.bdmajora.impetus.iris.shaderpack.ShaderProperties} — {@code shaders.properties} parser.</li>
 *   <li>{@link com.bdmajora.impetus.iris.shaderpack.include.IncludeProcessor} — recursive {@code #include} flattening
 *       with cycle detection and OptiFine relative/absolute path rules.</li>
 *   <li>{@link com.bdmajora.impetus.iris.shaderpack.preprocessor.GlslPreprocessor} — {@code #version} detection and
 *       {@code #define} injection.</li>
 *   <li>{@link com.bdmajora.impetus.iris.config.IrisConfig} — {@code optionsshaders.txt} read/write.</li>
 *   <li>{@link com.bdmajora.impetus.iris.Iris} — orchestrator wired into the {@code @Mod} init.</li>
 * </ul>
 *
 ...
 * </ul>
 */
package com.bdmajora.impetus.iris;
