...
/**
 * One sampler's texture unit and the texture it should hold (Iris {@code gl/sampler/SamplerBinding}).
 * <p>
 ...
 * <p>
 * Iris binds through {@code IrisRenderSystem.bindTextureToUnit}, which on a DSA driver is {@code glBindTextureUnit}
