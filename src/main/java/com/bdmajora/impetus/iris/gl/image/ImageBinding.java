...
/**
 * One image uniform's binding for one program (Iris {@code gl/image/ImageBinding}).
 * <p>
 * Re-resolved and re-bound at every program use rather than once per frame. Iris does the same
...
public class ImageBinding {
    ...
    public void update() {
        ...
        // declared with a depth needs, and it is harmless for a 2D image (layer 0 is the only layer). Iris binds
