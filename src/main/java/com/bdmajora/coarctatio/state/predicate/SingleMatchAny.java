...
// property=a|b|c, one property against a set of values: one object and one array where vanilla builds a composite, a transformed Iterable and N closures; fields public for AllMatchAnyObject to fold
