 ...
 *
 * <p>Differs from other living entities in two ways: the "Entities" switch does not silence a
 * player's held torch (that is what the separate first-person switch is for), and a spectator emits
 * nothing, since they are not really there.
 */
