package com.bdmajora.impetus.engine.gradle.mdg.remapper;
...
public abstract class GenerateNamedToIntermediaryTSRGTask extends DefaultTask {
    ...
    public void generate() {
        var mojmapMappings = getProject().getLayout().getBuildDirectory().dir("namedToIntermediaryImpetus").get().file("client_mappings.txt").getAsFile();
