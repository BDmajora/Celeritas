...
public class LWJGL2MemoryStack extends MemoryStack {
    private final com.bdmajora.impetus.lwjgl.lwjgl2.memory.MemoryStack delegate;

    public LWJGL2MemoryStack(com.bdmajora.impetus.lwjgl.lwjgl2.memory.MemoryStack delegate) {
